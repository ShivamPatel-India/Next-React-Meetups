...
async function getStaticPaths() {
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://shivam9292:shivam123@cluster0.fk9kj.mongodb.net/MeetupsDatabase?retryWrites=true&w=majority");
  const db = client.db();
